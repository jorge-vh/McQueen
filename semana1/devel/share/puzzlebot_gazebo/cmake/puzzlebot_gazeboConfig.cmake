...
if("TRUE" STREQUAL "TRUE")
  set(puzzlebot_gazebo_SOURCE_PREFIX /home/javh/Documents/McQueen/semana1/src/puzzlebot_gazebo)
  set(puzzlebot_gazebo_DEVEL_PREFIX /home/javh/Documents/McQueen/semana1/devel)
  ...
  set(puzzlebot_gazebo_INSTALL_PREFIX /home/javh/Documents/McQueen/semana1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'puzzlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/javh/Documents/McQueen/semana1/src/puzzlebot_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(puzzlebot_gazebo_EXPORTED_TARGETS ${${puzzlebot_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
